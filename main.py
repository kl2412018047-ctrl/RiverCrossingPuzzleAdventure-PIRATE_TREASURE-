...
try:
    ...
    try:
        ...
        background2 = background  # Fallback duplicate
    except Exception as e:
        print("Background Error: Menggunakan warna biru sebagai ganti.", e)
                    ...
                    for side_items in [left_side, right_side]:
                        if "Pirate" not in side_items:
                            if "Cannon" in side_items and "Map" in side_items:
                                ...
                                game_over = True
                            elif level == 2 and "Treasure" in side_items and "Key" in side_items:
                                gameover_sound.play()
                                game_message = "GAME OVER! Treasure stole the Key!"
                                game_over = True
                            elif "Treasure" in side_items and "Map" in side_items:
                                gameover_sound.play()
                                game_message = "GAME OVER! Rats ate the Map!"
                                game_over = True
                else:
